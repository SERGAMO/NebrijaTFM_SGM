...
class Graph:
    ...
    def update(self):
        ...
        for count, channel in enumerate(self.exg_channels):
            ...
            DataFilter.perform_bandstop(data[channel], self.sampling_rate, 48.0, 52.0, 2,FilterTypes.BUTTERWORTH_ZERO_PHASE, 0) #Blocks 50Hz AC
            #DataFilter.perform_bandpass(data[channel], self.sampling_rate, 3.0, 45.0, 2, FilterTypes.BUTTERWORTH_ZERO_PHASE, 0)
            DataFilter.perform_bandpass(data[channel], self.sampling_rate, 3.0, 25.0, 2, FilterTypes.BUTTERWORTH_ZERO_PHASE, 0)
            #DataFilter.perform_bandstop(data[channel], self.sampling_rate, 58.0, 62.0, 2,FilterTypes.BUTTERWORTH_ZERO_PHASE, 0)
            print(data[channel])
