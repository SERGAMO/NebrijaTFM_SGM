...
def run():                   #Main loop
    ...
    while True:              #Connection
        ...
        servo15.angle = angle_from_pwm(0)
        break
    ...
    while True: 
        ...
        if not data:
            ...
            servo1.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST1').encode())
        elif 'ST2' == data:
            set_ST = 'ST2'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo2.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST2').encode())
        elif 'ST3' == data:
            set_ST = 'ST3'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo3.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST3').encode())
        elif 'ST4' == data:
            set_ST = 'ST4'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo4.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST4').encode())
        elif 'ST5' == data:
            set_ST = 'ST5'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo5.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST5').encode())
        elif 'ST6' == data:
            set_ST = 'ST6'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo6.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST6').encode())
        elif 'ST7' == data:
            set_ST = 'ST7'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo7.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST7').encode())
        elif 'ST8' == data:
            set_ST = 'ST8'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo8.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST8').encode())
        elif 'ST9' == data:
            set_ST = 'ST9'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo9.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST9').encode())
        elif 'ST10' == data:
            set_ST = 'ST10'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo10.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST10').encode())
        elif 'ST11' == data:
            set_ST = 'ST11'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo11.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST11').encode())
        elif 'ST12' == data:
            set_ST = 'ST12'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo12.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('ST12').encode())
        elif 'ST13' == data:
            set_ST = 'ST13'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo13.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            ...
            set_ST = 'MIN'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo0.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            tcpCliSock.send(('MIN').encode())
        elif 'MAX' == data:
            set_ST = 'MAX'
            #pwm.set_pwm(set_L, 0, num_import_int('L%d_%s:'%(set_L,set_ST)))
            servo15.angle = angle_from_pwm(num_import_int('L%d_%s:'%(set_L,set_ST)))
            ...
            servo0.angle = angle_from_pwm(org)
            send_pwm=str(org)
            ...
            try:
                ...
                for i in range (1,(setps+1)):
                    ...
                    servo0.angle = angle_from_pwm(num_import_int('L%d_ST%d:'%(set_L,i)))
                    time.sleep(time_get)
            except:
                print('wrong args')
                pass
            ...
            try:
                ...
                for i in range (1,(setps+1)):
                    for x in range (0,16):
                        ...
                        servo_list[i].angle = angle_from_pwm(num_import_int('L%d_ST%d:'%(x,i)))
                    time.sleep(time_get)
            except:
                print('wrong args')
                pass
            ...
            try:
                for i in range (0,16):
                    ...
                    servo_list[i].angle = angle_from_pwm(num_import_int('L%d_%s:'%(i,set_ST)))
            except:
                print('wrong args')
                pass
            ...
            servo0.angle = angle_from_pwm(0)
            servo15.angle = angle_from_pwm(0)
            servo14.angle = angle_from_pwm(0)
            servo13.angle = angle_from_pwm(0)
            servo12.angle = angle_from_pwm(0)
            servo11.angle = angle_from_pwm(0)
            servo10.angle = angle_from_pwm(0)
            servo9.angle = angle_from_pwm(0)
            servo8.angle = angle_from_pwm(0)
            servo7.angle = angle_from_pwm(0)
            servo6.angle = angle_from_pwm(0)
            servo5.angle = angle_from_pwm(0)
            servo4.angle = angle_from_pwm(0)
