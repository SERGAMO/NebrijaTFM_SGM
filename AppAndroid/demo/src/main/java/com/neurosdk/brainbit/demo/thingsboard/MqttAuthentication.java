...
public class MqttAuthentication {
  ...
  private static final String DEFAULT_ALIAS = "Thingsboard CAT Tunnel BAlometer Authentication";
  ...
  public void initialize() {
    try {
      ...
      if (certificate instanceof X509Certificate) {
        ...
        Log.d(TAG, "Signature: " + BaseEncoding.base16().lowerCase().withSeparator(":", 2)  .encode(x509Certificate.getSignature()));
      }
